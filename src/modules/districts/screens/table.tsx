...
export default function DistrictsTableScreen() {
  ...
  const { data, isLoading, totalPages, totalElements } = usePaginatedData<IDistrict>('districts', 'districts', {
    page,
    limit: size,
  ...
  const columns: ColumnDef<IDistrict>[] = [
    {
      accessorKey: 'name',
    ...
    },
    {
      ...
      cell: (cell) => (
        <DataTableRowActions
          ...
          deleteEndpoint="districts/"
          deleteQueryKey="districts"
        />
      ),
    },
  ]
